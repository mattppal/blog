...
import cohort_grid from "@assets/posts/cohorted-retention/cohort-grid.png";
import spaghetti from "@assets/posts/cohorted-retention/spaghetti.jpg";
...
<center>
  <figure>
    <img src={cohort_grid.src} alt="Example user retention cohort grid." />
    <figcaption>
      <i>
        <center>
          Cohort months and totals are displayed for each row, with retention
          highlighted and colored by column.
        </center>
      </i>
    </figcaption>
  </figure>
...
<center>
  <figure>
    <img src={spaghetti.src} alt="Example spaghetti chart." />
    <figcaption>
      <i>
        <center>Example spaghetti chart for cohorted retention view.</center>
      </i>
    </figcaption>
  </figure>
</center>
