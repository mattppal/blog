...
import sponge_fire from "@assets/posts/level-up-medallion-architecture/sponge-fire.png";
...
<p style="text-align: center;">staging ➡️ intermediate ➡️ marts</p>

process for cleaning data. The convention isn't so important, I've also seen:

<p style="text-align: center;">
  raw ➡️ stg ➡️ curated,<br></br>
  clean ➡️ views,
</p>
...
<div class="container">
  <p style="text-align: center;">
    <iframe
      ...
      src="https://www.youtube.com/embed/D5hpjlYHEGw"
...
<img src={sponge_fire.src} alt=""></img>
