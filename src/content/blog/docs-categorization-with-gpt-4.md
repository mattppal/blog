...
draft: false
featured: true
ogImage: "../../assets/postsdocs-categorization-with-gpt-4/og.jpeg"
...
![](../../assets/postsdocs-categorization-with-gpt-4/og.jpeg)
...
![](../../assets/postsdocs-categorization-with-gpt-4/if-a-tree-falls.gif)
...
![](../../assets/postsdocs-categorization-with-gpt-4/having-fun.gif)
...
<img src="../../assets/postsdocs-categorization-with-gpt-4/mintlify-logo.svg" />
...
![Foreshadowing](../../assets/postsdocs-categorization-with-gpt-4/foreshadowing.gif)
...
![It's alive!](../../assets/postsdocs-categorization-with-gpt-4/its-alive-young-frankenstein.gif)
...
![Kryptonite](../../assets/postsdocs-categorization-with-gpt-4/dean-cain-superman.gif)
...
![Find replace gif](../../assets/postsdocs-categorization-with-gpt-4/find-replace.gif)
...
![Terminator gif](../../assets/postsdocs-categorization-with-gpt-4/terminator.gif)

## Lessons Learned

I presented this as a working solution, but in reality, it's not (I mean, it works _sometimes_ 😅), _but_ I learned a _ton_.

![Alt text](../../assets/postsdocs-categorization-with-gpt-4/lying-on-the-internet.png)
