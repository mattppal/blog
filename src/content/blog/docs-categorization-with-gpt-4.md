...
draft: false
featured: true
ogImage: "/src/assets../../assets/posts/docs-categorization-with-gpt-4/og.jpeg"
...
![](/src/assets../../assets/posts/docs-categorization-with-gpt-4/og.jpeg)
...
![](/src/assets../../assets/posts/docs-categorization-with-gpt-4/if-a-tree-falls.gif)
...
![](/src/assets../../assets/posts/docs-categorization-with-gpt-4/having-fun.gif)
...
<img src="/src/assets../../assets/posts/docs-categorization-with-gpt-4/mintlify-logo.svg" />
...
![Foreshadowing](/src/assets../../assets/posts/docs-categorization-with-gpt-4/foreshadowing.gif)
...
![It's alive!](/src/assets../../assets/posts/docs-categorization-with-gpt-4/its-alive-young-frankenstein.gif)
...
![Kryptonite](/src/assets../../assets/posts/docs-categorization-with-gpt-4/dean-cain-superman.gif)
...
![Find replace gif](/src/assets../../assets/posts/docs-categorization-with-gpt-4/find-replace.gif)
...
![Terminator gif](/src/assets../../assets/posts/docs-categorization-with-gpt-4/terminator.gif)

## Lessons Learned

I presented this as a working solution, but in reality, it's not (I mean, it works _sometimes_ 😅), _but_ I learned a _ton_.

![Alt text](/src/assets../../assets/posts/docs-categorization-with-gpt-4/lying-on-the-internet.png)
