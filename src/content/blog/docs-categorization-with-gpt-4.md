...
draft: false
featured: true
ogImage: "../../assets/posts/docs-categorization-with-gpt-4/og.jpeg"
...
![](../../assets/posts/docs-categorization-with-gpt-4/og.jpeg)
...
![](../../assets/posts/docs-categorization-with-gpt-4/if-a-tree-falls.gif)
...
![](../../assets/posts/docs-categorization-with-gpt-4/having-fun.gif)
...
<img src="../../assets/posts/docs-categorization-with-gpt-4/mintlify-logo.svg" />
...
![Foreshadowing](../../assets/posts/docs-categorization-with-gpt-4/foreshadowing.gif)
...
![It's alive!](../../assets/posts/docs-categorization-with-gpt-4/its-alive-young-frankenstein.gif)
...
![Kryptonite](../../assets/posts/docs-categorization-with-gpt-4/dean-cain-superman.gif)
...
![Find replace gif](../../assets/posts/docs-categorization-with-gpt-4/find-replace.gif)
...
![Terminator gif](../../assets/posts/docs-categorization-with-gpt-4/terminator.gif)

## Lessons Learned

I presented this as a working solution, but in reality, it's not (I mean, it works _sometimes_ 😅), _but_ I learned a _ton_.

![Alt text](../../assets/posts/docs-categorization-with-gpt-4/lying-on-the-internet.png)
