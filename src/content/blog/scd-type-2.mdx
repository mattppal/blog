...
import visitor_lookup from "@assets/posts/visitor-lookup/visitor_lookup.png";
import scd_type_2 from "@assets/posts/visitor-lookup/IMG_01.jpg";
...
<figure>
  <img src={scd_type_2.src} alt="Example behavior of SCD Type-2" />
  <figcaption>
    <i>
      <center>
        An example SCD Type-2 entry for a visitor switching userids
      </center>
    </i>
  </figcaption>
</figure>
...
<figure>
  <img src={visitor_lookup.src} alt="Execution schematic" />
  <figcaption>
    <i>
      <center>
        An example SCD Type-2 entry for a visitor switching userids
