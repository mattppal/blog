...
draft: false
featured: true
ogImage: "/src/assets../../assets/posts/what-is-delta/og.png"
...
<script>
    if (window.location.hostname !== "mattpalmer.io"){
        window.top.location.href = 'https://mattpalmer.io/src/assets../../assets/posts/what-is-delta';
    }
</script>
...
![Header image](/src/assets../../assets/posts/what-is-delta/header-2.png)
...
![This is a lakehouse, not delta](/src/assets../../assets/posts/what-is-delta/delta-example.png)
...
![This is also a lakehouse](/src/assets../../assets/posts/what-is-delta/lakehouse-arch.png)
...
![Actually Delta Lake](/src/assets../../assets/posts/what-is-delta/delta-metadata.png)
...
![Not Hudi](/src/assets../../assets/posts/what-is-delta/hudi-example.png)
...
![Great Scott](/src/assets../../assets/posts/what-is-delta/great-scott.gif)
...
Delta tables are _both_ batch tables _and_ streaming sources/sinks. I'll refrain from joining [that debate](https://www.linkedin.com/src/assets../../assets/posts/daniel-beach-6ab8b4132_datainfluncers-meta-google-activity-7078024000479645696-MzCe), but hey, flexibility is good.
...
![Larry David pretty pretty good](/src/assets../../assets/posts/what-is-delta/larry-david-pretty-good.gif)
...
One of the first [posts I ever wrote](/src/assets../../assets/posts/scd-type-2) was about creating an SCD Type-2 table using `UPSERT` in Delta. Admittedly, that was in 2021 and I had little idea what I was doing. Hopefully, someone has a better guide or much-improved process by now. 😂
...
![Drake Parquet Meme](/src/assets../../assets/posts/what-is-delta/drake-parquet.png)
...
![I'm watching you...](/src/assets../../assets/posts/what-is-delta/wazowski.gif)
...
![Uniform in Delta 3.0](/src/assets../../assets/posts/what-is-delta/uniform.png)
...
![Uniform read performance](/src/assets../../assets/posts/what-is-delta/uniform-read.png)
