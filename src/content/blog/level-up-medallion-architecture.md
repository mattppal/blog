...
draft: false
featured: true
ogImage: "/src/assets../../assets/posts/level-up-medallion-architecture/og.png"
...
![Header image](/src/assets../../assets/posts/level-up-medallion-architecture/header.png)

## ToC

## 🏃‍♂️ Going for Gold

In the theme of my [last article](/src/assets../../assets/posts/what-is-delta), we're continuing with Databricks-inspired buzzwords. I like this one because it lets me make liberal use of running emojis. 🤷‍♂️
...
![Medallion Architecture](/src/assets../../assets/posts/level-up-medallion-architecture/architecture.png)
...
![Youtube snippet](/src/assets../../assets/posts/level-up-medallion-architecture/periscope.png)
...
![Forest running](/src/assets../../assets/posts/level-up-medallion-architecture/run-forest-run.gif)
...
<img src='/src/assets../../assets/posts/level-up-medallion-architecture/sponge-fire.png'>
...
![I felt like it](/src/assets../../assets/posts/level-up-medallion-architecture/keep-running.gif)
